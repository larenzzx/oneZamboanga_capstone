...
// Fetch assigned workers for the specified evacuation center, excluding the specified worker_id
$assignedWorkersSql = "
    ...
    WHERE aw.evacuation_center_id = ? AND aw.status = 'assigned' AND w.id != ?
";
$assignedWorkersStmt = $conn->prepare($assignedWorkersSql);
$assignedWorkersStmt->bind_param("ii", $evacuationCenterId, $workerId);
                        ...
                        <section class="tblbody">
                            <table id="mainTable">
                                ...
                                <tbody id="workerTableBody">
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="6" style="text-align: center;">No Other Assigned Worker Yet!</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
